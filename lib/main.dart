...
// import 'package:food_delivery/admin/list_food_admin.dart';
...
void main() async {
  ...
  //   url: 'https://pilxbeusqqgcuhufxjnk.supabase.co',
  //   anonKey:
  //       'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBpbHhiZXVzcXFnY3VodWZ4am5rIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDkzNTc2NTAsImV4cCI6MjA2NDkzMzY1MH0.l_HiDJgUkZfE_HfcKtVSAoameVnKnF4t6-ylceEBP3A',
  // );
  runApp(const MyApp());
}
